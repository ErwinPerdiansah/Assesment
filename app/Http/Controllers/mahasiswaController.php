...
class mahasiswaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $jumlahbaris = 10;
        if(strlen($katakunci)){
            $data = mahasiswa::where('nim','like',"%$katakunci%")->orWhere('nama','like',"%$katakunci%")->orWhere('jurusan','like',"%$katakunci%")->orWhere('matakuliah','like',"%$katakunci%")->orWhere('dosenpembimbing','like',"%$katakunci%")->paginate($jumlahbaris);
        }else{
    ...
    public function store(Request $request)
    {
        ...
        FacadesSession::flash('matakuliah',$request->matakuliah);
        FacadesSession::flash('dosenpembimbing',$request->dosenpembimbing);
        ...
        $request->validate([
            ...
            'dosenpembimbing.required'=>'dosenpembimbing wajib diisi',
        ]);
        $data = [
            'nim' => $request->nim,
            'nama' => $request->nama,
