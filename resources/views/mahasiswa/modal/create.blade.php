            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='matakuliah' value="{{ Session::get('matakuliah') }}"
                                    id="matakuliah">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='dosenpembimbing' value="{{ Session::get('dosenpembimbing') }}"
                                    id="dosenpembimbing">
                            </div>
                        </div>
                </div>
