                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='matakuliah' value="{{ $item->matakuliah }}"
                                    id="matakuliah">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name='dosenpembimbing' value="{{ $item->dosenpembimbing }}"
                                    id="dosenpembimbing">
                            </div>
                        </div>
